        ...
        <div className="pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="md:grid md:grid-cols-12 md:gap-12 lg:gap-20 items-center">
            ...
            <div className="md:col-span-7 lg:col-span-7 mb-8 md:mb-0 text-center md:text-left">
              ...
              <h1 className="h1 lg:text-5xl mb-4 font-red-hat-display font-extrabold" data-aos="fade-down">Communicate Offline at the Largest Events</h1>
              {/* Communicate Offline at the Largest Events */}
              <p className="text-xl text-gray-600 dark:text-gray-400" data-aos="fade-down" data-aos-delay="150">Organize successful events - All in the absence of internet connection.</p>
              {/* <p className="text-xl text-gray-600 dark:text-gray-400" data-aos="fade-down" data-aos-delay="150">A Reliable Offline Mode of Communication Essential for Successful Events.</p> */}
              {/* CTA form */}
              ...
              <ul className="max-w-sm sm:max-w-md mx-auto md:max-w-none text-gray-600 dark:text-gray-400 mt-8 -mb-2" data-aos="fade-down" data-aos-delay="450">
                <li className="flex items-center mb-2">
                  ...
                  <span>Broadcast Messages to Attendees</span>
                </li>
                <li className="flex items-center mb-2">
                  <svg className="w-3 h-3 fill-current text-teal-400 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                  </svg>
                  <span>Manage your Event Staff</span>
                </li>
                <li className="flex items-center mb-2">
                  <svg className="w-3 h-3 fill-current text-teal-400 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                  </svg>
                  <span>Receive Event Analytics in Real-Time</span>
                </li>
              </ul>
              <form className="mt-8" data-aos="fade-down" data-aos-delay="300">
                <div className="flex flex-col sm:flex-row justify-center max-w-sm mx-auto sm:max-w-md md:mx-0">
                  ...
                  <a className="btn text-white bg-teal-500 hover:bg-teal-400 shrink-0 w-full" onClick={openFormModal}>Request a Demo</a>
                </div>
                {/* Success message */}
