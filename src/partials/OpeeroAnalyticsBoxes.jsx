        ...
        <div className="pb-12 md:pb-20">
          <div className="grid grid-cols-1 gap-4 lg:gap-6 md:grid-cols-3 text-center" data-aos-id-stats>
            ...
            <div className="bg-white dark:bg-gray-800 py-8 px-1 shadow-2xl" data-aos="fade-down" data-aos-anchor="[data-aos-id-stats]">
              <div className="font-red-hat-display text-2xl font-extrabold tracking-tighter mb-1">Analytics Dashboard</div>
              {/* <div className="text-gray-600 dark:text-gray-400">Analytics Dashboard</div> */}
            </div>
            {/* 2nd item */}
            <div className="bg-white dark:bg-gray-800 py-8 px-1 shadow-2xl" data-aos="fade-down" data-aos-anchor="[data-aos-id-stats]" data-aos-delay="100">
              <div className="font-red-hat-display text-2xl font-extrabold tracking-tighter mb-1">Geo-Granular Statistics</div>
              {/* <div className="text-gray-600 dark:text-gray-400">Geo-Granular Statistics</div> */}
            </div>
            {/* 3rd item */}
            <div className="bg-white dark:bg-gray-800 py-8 px-1 shadow-2xl" data-aos="fade-down" data-aos-anchor="[data-aos-id-stats]" data-aos-delay="200">
              <div className="font-red-hat-display text-2xl font-extrabold tracking-tighter mb-1">Foot Traffic Heat-Map</div>
              {/* <div className="text-gray-600 dark:text-gray-400">Foot Traffic Heat Map</div> */}
            </div>
            {/* 4th item */}
...
export default OpeeroAnalyticsBoxes;