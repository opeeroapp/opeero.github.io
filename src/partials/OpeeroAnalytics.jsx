      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h2 className="h2 font-red-hat-display mb-4">Track event-tailored metrics live.</h2>
            ...
            <div className="grid lg:grid-cols-3 gap-12 lg:gap-6">
              ...
              <div className="lg:col-span-1 lg:pr-16 flex flex-wrap justify-center lg:flex-col lg:justify-start -m-1 lg:mx-0">
                ...
                >
                  ...
                  <span className={category === '1' ? 'text-white dark:text-teal-400' : 'text-gray-600 dark:text-gray-300'}>Anayltics Dashboard</span>
                </button>
                <button
                ...
                >
                  ...
                  <span className={category === '2' ? 'text-white dark:text-teal-400' : 'text-gray-600 dark:text-gray-300'}>Total event attendees</span>
                </button>
                <button
                ...
                >
                  ...
                  <span className={category === '3' ? 'text-white dark:text-teal-400' : 'text-gray-600 dark:text-gray-300'}>Geo-Granular Statistics</span>
                </button>
                {/* <button
                ...
                >
                  ...
                  <span className={category === '4' ? 'text-white dark:text-teal-400' : 'text-gray-600 dark:text-gray-300'}>Foot Traffic Heat Map</span>
                </button> */}
                <button
                ...
                >
                  ...
                  <span className={category === '5' ? 'text-white dark:text-teal-400' : 'text-gray-600 dark:text-gray-300'}>Foot Traffic Heat Map</span>
                </button>
              </div>
...
export default OpeeroAnalytics;
