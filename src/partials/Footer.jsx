        ...
        <div className="py-12 md:py-20">
            ...
            <div className="md:flex md:items-center md:justify-between">
                ...
                <ul className="flex mb-4 md:order-2 md:ml-4 md:mb-0">
                    <li>
                        <a className="flex justify-center items-center text-white bg-teal-500 dark:text-teal-500 dark:bg-gray-800 hover:underline hover:bg-teal-600 rounded-full transition duration-150 ease-in-out" href="https://twitter.com/OpeeroApp" aria-label="Twitter">
                ...
                {/* Copyrights note */}
                <div className="text-gray-600 dark:text-gray-400 text-sm mr-4">&copy; Opeero.com. All rights reserved.</div>
